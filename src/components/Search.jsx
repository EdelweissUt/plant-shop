const Search = () => {
    return (<div className="searchBox w-[100%] h-[50px] ">
            <form action="/search" className=" w-full px-4">
                <div className="relative">
                    <input type="text" name="q"
                           className="w-full border h-12 shadow p-4 rounded-full dark:text-gray-800 dark:border-gray-700 dark:bg-gray-200 bg-white"
                           placeholder="search"/>
                    <button type="submit">
                        <svg
                            className="text-teal-400 dark:text-teal-300 h-5 w-5 absolute top-3.5 right-3 fill-current"
