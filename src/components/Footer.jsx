...
const Footer = () => {
    ...
    return (
        <footer className="relative bg-black text-[#354A27]">
            <div className="absolute top-0 left-0 w-[100%] overflow-hidden bg-[#F5F5DC]">
                ...
                <div className="grid lg:grid-cols-4 gap-20 sm:grid-cols-1 p-20">
                    ...
                    <div className="mb-4 md:mb-0">
                        ...
                        <div className="flex space-x-4">
                            <a
                                className="text-[#354A27] hover:text-pink-500 transform hover:scale-150
                ...
                <div className="mt-20">
                    <div className="h-full flex items-center justify-center mb-5">
                        <form className="w-96 relative">
                            ...
                            <button
                                type="Submit"
                                className="bg-pink-400 px-8 py-2 rounded-full text-[#354A27]
                ...
                <h6 className="text-center">&copy; right plantShop {Year}</h6>
            </div>
        </footer>
    );
};
