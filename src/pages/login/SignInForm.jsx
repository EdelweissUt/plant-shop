...
function SignInForm() {
    return (
        <form action="#" className="forms lsign-in-form">
            ...
            <input type="submit" value="Login" className="lbtn lsolid" />
            <p className="lsocial-text">Or Sign in with social platforms</p>
